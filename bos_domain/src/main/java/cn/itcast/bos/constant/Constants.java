...
public class Constants {
	...
	public static final String CRM_MANAGEMENT_HOST = "http://localhost:9002"; //9002
	public static final String BOS_FORE_HOST = "http://localhost:9003";//9003
	public static final String BOS_SMS_HOST = "http://localhost:9004"; //9004
	public static final String BOS_MAIL_HOST = "http://localhost:9005"; //9005
